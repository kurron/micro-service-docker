...
#docker run --rm --detach --hostname="micro-service" --name="micro-service" --memory="256m" --publish 8080:8080 --link mongodb:mongodb --link rabbitmq:rabbitmq  kurron/micro-service-docker:latest
docker run --rm --interactive --tty --hostname="micro-service" --name="micro-service" --memory="256m" --publish 8080:8080 --link mongodb:mongodb --link rabbitmq:rabbitmq  kurron/micro-service-docker:latest /bin/bash
