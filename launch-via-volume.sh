...
#docker run --rm --detach --env-file=micro-service-environment.sh --hostname="micro-service" --name="micro-service" --memory="256m" --publish 8080:8080 --volume /home/vagrant/GitHub/micro-service-docker:/root/config kurron/micro-service-docker:latest
docker run --rm --interactive --tty --hostname="micro-service" --name="micro-service" --memory="256m" --publish 8080:8080 --volume /home/vagrant/GitHub/micro-service-docker:/root/config kurron/micro-service-docker:latest /bin/bash
