...
docker run --rm --interactive --tty --hostname="micro-service" --name="micro-service" --memory="256m" --publish 8080:8080 kurron/micro-service-docker:latest /bin/bash --spring.data.mongodb.host="192.168.1.233" --spring.rabbitmq.host="192.168.1.233"  --info.app.description="command-line" /bin/bash
