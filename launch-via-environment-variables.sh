...
#docker run --detach --env-file=micro-service-environment.sh --hostname="micro-service" --name="micro-service" --memory="256m" --publish 8080:8080 kurron/micro-service-docker:latest
docker run --interactive --tty --env-file=micro-service-environment.sh --hostname="micro-service" --name="micro-service" --memory="256m" --publish 8080:8080 kurron/micro-service-docker:latest /bin/bash
